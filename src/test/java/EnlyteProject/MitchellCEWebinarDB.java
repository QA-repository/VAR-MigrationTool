...
public class MitchellCEWebinarDB {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String fileName = "Mitchell CE Webinar Sheet_";
        String sqlQuery = "SELECT " +
                ...
                "WHERE " +
                "nfd.type = 'Webinar' " +
                "AND ti.tid NOT IN (2231, 2246) " +
                "GROUP BY " +
                "nfd.nid;";
        //To get all articles in the site use the below query
        //SELECT nfd.title, n.uuid AS node__uuid FROM  node_field_data nfd LEFT JOIN node n ON n.nid = nfd.nid WHERE nfd.type = 'article';
