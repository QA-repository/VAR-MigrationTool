...
public class MitchellTaxonomiesDB {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String fileName = "Mitchell Markets Taxonomy Sheet_";
        ...
        String fileName2 = "Mitchell Tags Taxonomy Sheet_";
        ...
        String fileName3 = "Mitchell Topics Taxonomy Sheet_";
