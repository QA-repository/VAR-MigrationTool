...
public class EnlyteAllCEWebinarDB {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String fileName = "Enlyte Live All CE Webinar Sheet_";
        //String sqlQuery = "SELECT nfd.title, n.uuid AS node__uuid FROM node_field_data nfd LEFT JOIN node n ON n.nid = nfd.nid WHERE nfd.type = 'webinar';";
