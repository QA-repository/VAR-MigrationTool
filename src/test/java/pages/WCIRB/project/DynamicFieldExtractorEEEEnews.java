...
public class DynamicFieldExtractorEEEEnews {
    ...
    private static Map<String, String> getFieldTitles() {
        ...
        fieldTitles.put(" body[0][summary]", "summary");
        fieldTitles.put("field_tags[]", "field_tags");
        fieldTitles.put("field_e_newletter_type", "field_e_newletter_type");
    ...
    private static void writeWorkbookToFile(Workbook workbook) throws IOException {
        try (FileOutputStream fileOut = new FileOutputStream("output1news.xlsx")) {
